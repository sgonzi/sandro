...
//------------------ x_vs_eta
	...
	//Output
	string out_x_vs_eta = "Subtract_2_PixelBarrelConn1_and_PixelBarrelConn2_x_vs_eta";        
	...
	TFile* outplots_x_vs_eta = new TFile(outputroot_x_vs_eta.c_str(), "RECREATE");	
        ...
        //Create new Canva
        TCanvas *Subtract_c1_x_vs_eta = new TCanvas("Subtract_c1", "Subtract_c1", 800, 800);
        Subtract_c1_x_vs_eta->Range(0,0,25,25);
        Subtract_c1_x_vs_eta->SetLeftMargin(0.160);
        Subtract_c1_x_vs_eta->Draw();
...
//        TH1D *Original_THStack_0_x_vs_eta = (TH1D*) Original_THStack_x_vs_eta->GetStack()->At(0);
        ...
        //Subtract et impera
        Modified_THStack_5_x_vs_eta->Add(Original_THStack_5_x_vs_eta, -1);
//        Modified_THStack_4_x_vs_eta->Add(Original_THStack_4_x_vs_eta, -1);
//        Modified_THStack_3_x_vs_eta->Add(Original_THStack_3_x_vs_eta, -1);
//        Modified_THStack_2_x_vs_eta->Add(Original_THStack_2_x_vs_eta, -1);
//        Modified_THStack_1_x_vs_eta->Add(Original_THStack_1_x_vs_eta, -1);
//        Modified_THStack_0_x_vs_eta->Add(Original_THStack_0_x_vs_eta, -1);
...
//        Modified_THStack_4_x_vs_eta->Draw("histo same");
        ...
        Modified_THStack_5_x_vs_eta->SetYTitle("t/X_{0}");
  ...
  //      Modified_THStack_5_x_vs_eta.GetYaxis()->SetRangeUser(0.999, 1.008);
        ...
        // Legenda
//       TLegend *theLegend_Subtract = new TLegend(0.18,0.8,0.98,0.92); //$$ per inserire la TLegend al posto giusto
//       theLegend_Subtract->SetNColumns(3); //$$
//       theLegend_Subtract->SetFillColor(0); //$$
//       theLegend_Subtract->SetFillStyle(0); //$$
//       theLegend_Subtract->SetBorderSize(0); //$$
//       theLegend_Subtract->AddEntry(Modified_THStack_5,  "Support Tube",  "f");
//       theLegend_Subtract->AddEntry(Modified_THStack_3,      "TOB",      "f");
//       theLegend_Subtract->AddEntry(Modified_THStack_1,    "Pixel",    "f");
//       theLegend_Subtract->AddEntry(Modified_THStack_4,      "TEC",      "f");
//       theLegend_Subtract->AddEntry(Modified_THStack_2,       "TIB and TID",  "f");
//       theLegend_Subtract->AddEntry(Modified_THStack_0, "Beam Pipe","f");
//       theLegend_Subtract->Draw();
  //
         Subtract_c1_x_vs_eta->SaveAs((outputpdf_x_vs_eta.c_str()));
         // Subtract_c1_x_vs_eta->SaveAs((outputpng_x_vs_eta.c_str()));
         Subtract_c1_x_vs_eta->SaveAs((outputroot_x_vs_eta.c_str()));
         // Subtract_c1_x_vs_eta->SaveAs((outputC_x_vs_eta.c_str()));
...
//------------------ l_vs_eta
	...
	//Output
	string out_l_vs_eta = "Subtract_2_PixelBarrelConn1_and_PixelBarrelConn2_l_vs_eta";        
	...
	TFile* outplots_l_vs_eta = new TFile(outputroot_l_vs_eta.c_str(), "RECREATE");	
        ...
        //Create new Canva
        TCanvas *Subtract_c1_l_vs_eta = new TCanvas("Subtract_c1", "Subtract_c1", 800, 800);
        Subtract_c1_l_vs_eta->Range(0,0,25,25);
        Subtract_c1_l_vs_eta->SetLeftMargin(0.160);
        Subtract_c1_l_vs_eta->Draw();
...
//        TH1D *Original_THStack_0_l_vs_eta = (TH1D*) Original_THStack_l_vs_eta->GetStack()->At(0);
        ...
        //Subtract et impera
        Modified_THStack_5_l_vs_eta->Add(Original_THStack_5_l_vs_eta, -1);
//        Modified_THStack_4_l_vs_eta->Add(Original_THStack_4_l_vs_eta, -1);
//        Modified_THStack_3_l_vs_eta->Add(Original_THStack_3_l_vs_eta, -1);
//        Modified_THStack_2_l_vs_eta->Add(Original_THStack_2_l_vs_eta, -1);
//        Modified_THStack_1_l_vs_eta->Add(Original_THStack_1_l_vs_eta, -1);
//        Modified_THStack_0_l_vs_eta->Add(Original_THStack_0_l_vs_eta, -1);
...
//        Modified_THStack_4_l_vs_eta->Draw("histo same");
        ...
        Modified_THStack_5_l_vs_eta->SetYTitle("t/#lambda_{I}");
...
//       theLegend_Subtract->Draw();
  //
         Subtract_c1_l_vs_eta->SaveAs((outputpdf_l_vs_eta.c_str()));
         // Subtract_c1_l_vs_eta->SaveAs((outputpng_l_vs_eta.c_str()));
         Subtract_c1_l_vs_eta->SaveAs((outputroot_l_vs_eta.c_str()));
         // Subtract_c1_l_vs_eta->SaveAs((outputC_l_vs_eta.c_str()));
