#ifndef Closure_GJetsAnalyzer_h
#define Closure_GJetsAnalyzer_h
...
//  	TBranch      *b_QGVars;
  	...
  	TBranch      *b_PUWeightSysDown;  	
		...
		Closure_GJetsAnalyzer(TTree *tree = 0, Int_t isample = -1);
		virtual ~Closure_GJetsAnalyzer();
...
#ifdef Closure_GJetsAnalyzer_cxx
Closure_GJetsAnalyzer::Closure_GJetsAnalyzer(TTree *tree, Int_t isample) {
  ...
  file_address_s = "";
	...
	isMC = false;
	if (mysample == 0 || (mysample > 17 && mysample < 121)) isMC = true;
  ...
  if (tree == 0) {
		...
		bool outrange;
		outrange = mysample < 0 || (mysample > 4 && mysample < 11) || (mysample > 15 && mysample < 21) || (mysample > 24 && mysample < 31) || (mysample > 41 && mysample < 51) || (mysample > 51 && mysample < 61) || (mysample > 66 && mysample < 71) || (mysample > 76 && mysample < 81) || (mysample > 84 && mysample < 121) || (mysample > 124 && mysample < 151) || (mysample > 151 && mysample < 161) || (mysample > 166 && mysample < 171) || mysample > 176;
		...
		cout << "-----------------------------------------------------" << endl;
		cout << "mysample == 1   -> DATA RR Run2012A-22Jan2013" << endl;
		cout << "mysample == 2   -> DATA RR Run2012B-22Jan2013" << endl;
		cout << "mysample == 3   -> DATA RR Run2012C-22Jan2013" << endl;
		cout << "mysample == 4   -> DATA RR Run2012D-22Jan2013" << endl;
		cout << "-----------------------------------------------------" << endl;
		cout << "mysample == 11  -> DATA PR Run2012A-13Jul2012" << endl;
		cout << "mysample == 12  -> DATA PR Run2012A-recover-06Aug2012" << endl;
		cout << "mysample == 13  -> DATA PR Run2012B-13Jul2012" << endl;
		cout << "mysample == 14  -> DATA PR Run2012C-24Aug2012" << endl;
		cout << "mysample == 15  -> DATA PR Run2012C-EcalRecover_11Dec2012" << endl;
		cout << "mysample == 16  -> DATA PR Run2012C-PromptReco" << endl;
		cout << "mysample == 17  -> DATA PR Run2012D-PromptReco" << endl;
		cout << "-----------------------------------------------------  " << endl;
		cout << "mysample == 21  -> GJets 40<HT<100" << endl;
		cout << "mysample == 22  -> Gjets 100<HT<200" << endl;
		cout << "mysample == 23  -> GJets 200<HT<400" << endl;
		cout << "mysample == 24  -> Gjets 400<HT<Inf" << endl;
		cout << "-----------------------------------------------------  " << endl;
		cout << "mysample == 31  -> G 15<Pt<30" << endl;
		cout << "mysample == 32  -> G 30<Pt<50" << endl;
		cout << "mysample == 33  -> G 50<Pt<80" << endl;
		cout << "mysample == 34  -> G 80<Pt<120" << endl;
		cout << "mysample == 35  -> G 120<Pt<170" << endl;
		cout << "mysample == 36  -> G 170<Pt<300" << endl;
		cout << "mysample == 37  -> G 300<Pt<470" << endl;
		cout << "mysample == 38  -> G 470<Pt<800" << endl;
		cout << "mysample == 39  -> G 800<Pt<1400" << endl;
		cout << "mysample == 40  -> G 1400<Pt<1800" << endl;
		cout << "mysample == 41  -> G 1800<Pt<Inf" << endl;
		cout << "-----------------------------------------------------" << endl;
		cout << "mysample == 51  -> DiPhotonJets" << endl;
		cout << "-----------------------------------------------------" << endl;
		cout << "mysample == 61  -> QCD EMEnriched 20<Pt<30" << endl;
		cout << "mysample == 62  -> QCD EMEnriched 30<Pt<80" << endl;
		cout << "mysample == 63  -> QCD EMEnriched 80<Pt<170" << endl;
		cout << "mysample == 64  -> QCD EMEnriched 170<Pt<250" << endl;
		cout << "mysample == 65  -> QCD EMEnriched 250<Pt<350" << endl;
		cout << "mysample == 66  -> QCD EMEnriched 350<Pt<Inf" << endl;
		cout << "-----------------------------------------------------  " << endl;
		cout << "mysample == 71  -> QCD BCtoE 20<Pt<30" << endl;
		cout << "mysample == 72  -> QCD BCtoE 30<Pt<80" << endl;
		cout << "mysample == 73  -> QCD BCtoE 80<Pt<170" << endl;
		cout << "mysample == 74  -> QCD BCtoE 170<Pt<250" << endl;
		cout << "mysample == 75  -> QCD BCtoE 250<Pt<350" << endl;
		cout << "mysample == 76  -> QCD BCtoE 350<Pt<Inf" << endl;
		cout << "-----------------------------------------------------  " << endl;
		cout << "mysample == 81  -> QCD 100<HT<250" << endl;
		cout << "mysample == 82  -> QCD 250<HT<500" << endl;
		cout << "mysample == 83  -> QCD 500<HT<1000" << endl;
		cout << "mysample == 84  -> QCD 1000<HT<inf" << endl;
		cout << "-----------------------------------------------------  " << endl;
		cout << "mysample == 121  -> PSEUDODATA GJets 40<HT<100" << endl;
		cout << "mysample == 122  -> PSEUDODATA Gjets 100<HT<200" << endl;
		cout << "mysample == 123  -> PSEUDODATA GJets 200<HT<400" << endl;
		cout << "mysample == 124  -> PSEUDODATA Gjets 400<HT<Inf" << endl;
		cout << "-----------------------------------------------------" << endl;
		cout << "mysample == 151  -> PSEUDODATA DiPhotonJets" << endl;
		cout << "-----------------------------------------------------" << endl;
		cout << "mysample == 161  -> PSEUDODATA QCD EMEnriched 20<Pt<30" << endl;
		cout << "mysample == 162  -> PSEUDODATA QCD EMEnriched 30<Pt<80" << endl;
		cout << "mysample == 163  -> PSEUDODATA QCD EMEnriched 80<Pt<170" << endl;
		cout << "mysample == 164  -> PSEUDODATA QCD EMEnriched 170<Pt<250" << endl;
		cout << "mysample == 165  -> PSEUDODATA QCD EMEnriched 250<Pt<350" << endl;
		cout << "mysample == 166  -> PSEUDODATA QCD EMEnriched 350<Pt<Inf" << endl;
		cout << "-----------------------------------------------------  " << endl;
		cout << "mysample == 171  -> PSEUDODATA QCD BCtoE 20<Pt<30" << endl;
		cout << "mysample == 172  -> PSEUDODATA QCD BCtoE 30<Pt<80" << endl;
		cout << "mysample == 173  -> PSEUDODATA QCD BCtoE 80<Pt<170" << endl;
		cout << "mysample == 174  -> PSEUDODATA QCD BCtoE 170<Pt<250" << endl;
		cout << "mysample == 175  -> PSEUDODATA QCD BCtoE 250<Pt<350" << endl;
		cout << "mysample == 176  -> PSEUDODATA QCD BCtoE 350<Pt<Inf" << endl;
		cout << "-----------------------------------------------------  " << endl;
...
// data ReReco ----------------------------------------------------------
			...
			file_sample = "SinglePhoton_Run2012B-22Jan2013-v1_AOD.root";
			file_address_s = (folder_samples + file_sample).c_str();
			const char * file_address = file_address_s.c_str();
			TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(file_address);
			if (!f) {
			...
			file_sample = "SinglePhoton_Run2012C-22Jan2013-v1_AOD.root";
			file_address_s = (folder_samples + file_sample).c_str();
			const char * file_address = file_address_s.c_str();
			TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(file_address);
			if (!f) {
...
// CLOSURE TEST: MC signal GJets_HT-xToy ----------------------------------------------  
...
// CLOSURE TEST: MC signal DiPhotonJets ------------------------------------------------------
...
// CLOSURE TEST: MC background QCD HT-xToy --------------------------------------------
...
// CLOSURE TEST: MC background QCD_Pt_x_y BCtoE ----------------------------------
...
Closure_GJetsAnalyzer::~Closure_GJetsAnalyzer() {
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}


Int_t Closure_GJetsAnalyzer::GetEntry(Long64_t entry) {
...
Long64_t Closure_GJetsAnalyzer::LoadTree(Long64_t entry) {
...
void Closure_GJetsAnalyzer::Init(TTree *tree) {
...
Bool_t Closure_GJetsAnalyzer::Notify() {
...
void Closure_GJetsAnalyzer::Show(Long64_t entry) {
...
Int_t Closure_GJetsAnalyzer::Cut(Long64_t entry) {
...
/*
TString Closure_GJetsAnalyzer::floatToString(float number){
	ostringstream oss;
	oss << number;
	return oss.str();
}
*/
#endif // #ifdef Closure_GJetsAnalyzer_cxx
