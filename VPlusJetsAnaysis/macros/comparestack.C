...
Char_t QCDname3[100];
 ...
 sprintf(dataname,"Data_gammahistos_%d.root",itype);
 cout << "data file is " << dataname << endl;
 sprintf(Gname1,"GJetsHT100-200_gammahistos_%d.root",itype);
 cout << "G file 1 is " << Gname1 << endl;
 sprintf(Gname2,"GJetsHT200-inf_gammahistos_%d.root",itype);
 cout << "G file 2 is " << Gname2 << endl;
 sprintf(QCDname1,"QCDHT250-500_gammahistos_%d.root",itype);
 cout << "QCD file 1 is " << QCDname1 << endl;
 sprintf(QCDname2,"QCDHT500-1000_gammahistos_%d.root",itype);
 cout << "QCD file 2 is " << QCDname1 << endl;
 sprintf(QCDname3,"QCDHT1000_gammahistos_%d.root",itype);
 cout << "QCD file 3 is " << QCDname1 << endl;
...
Datahisto->GetYaxis()->SetLabelSize(0.03);
   ...
   leg->AddEntry(Datahisto,"Data 5.0/fb","pL");
   leg->AddEntry(Ghisto1,"#gamma+jets","f");
   leg->AddEntry(QCDhisto1,"QCD backg","f");
   leg->SetFillColor(10);
   leg->SetLineColor(10);
   leg->Draw();
