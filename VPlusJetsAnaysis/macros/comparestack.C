...
*/
	...
	cout << "QCD total entries " << QCD_Pt_x_y_EMEnriched_total_histo->Integral() << endl;  
//	cout << "QCD total entries " << QCD_HT_100To250_histo->Integral() << endl;  


  TCanvas *c1=new TCanvas(titlehisto,titlehisto);  
...
//	MC_stack->Add(QCD_HT_100To250_histo);
	...
	TH1F *ratio_histo_NUM = (TH1F*) Datahisto->Clone("ratio_histo_NUM");
...
//	leg->AddEntry(QCD_HT_100To250_histo,"QCD","f");
  ...
  text->AddText("#sqrt{s} = 8 TeV, L = fb^{-1}");
