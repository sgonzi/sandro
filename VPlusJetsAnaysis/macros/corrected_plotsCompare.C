...
void corrected_plotsCompare_54(){
	corrected_comparestack("SelectedPhotons_Pt_excl1_1_", "p_{T}^{#gamma_{1}} [GeV/#font[12]{c}], 1 jet exclusive", 4, 0, 2000);
	corrected_comparestack("SelectedPhotons_E_excl1_1_", "E^{#gamma_{1}} [GeV], 1 jet exclusive", 4, 0, 2000);

	string geom;
	geom = geo_string(geom);
	if (geom == "barrel"){	
		corrected_comparestack("SelectedPhotons_Eta_excl1_1_", "#eta^{#gamma_{1}}, 1 jet exclusive", 30, -1.5, 1.5); // barrel
	}
	if (geom == "endcaps" || geom == "total"){ 
		corrected_comparestack("SelectedPhotons_Eta_excl1_1_", "#eta^{#gamma_{1}}, 1 jet exclusive", 30, -3, 3); // endcaps or total
	}
	
	corrected_comparestack("SelectedPhotons_Phi_excl1_1_", "#varphi^{#gamma_{1}}, 1 jet exclusive", 20, -999, -999);
}
...
void corrected_plotsCompare_56(){
	corrected_comparestack("SelectedPhotons_Pt_excl2_1_", "p_{T}^{#gamma_{1}} [GeV/#font[12]{c}], 2 jet exclusive", 4, 0, 2000);
	corrected_comparestack("SelectedPhotons_E_excl2_1_", "E^{#gamma_{1}} [GeV], 2 jet exclusive", 4, 0, 2000);
	
	string geom;
	geom = geo_string(geom);
	if (geom == "barrel"){
	corrected_comparestack("SelectedPhotons_Eta_excl2_1_", "#eta^{#gamma_{1}}, 2 jet exclusive", 30, -1.5, 1.5); // barrel
	}
	if (geom == "endcaps" || geom == "total"){ 	
		corrected_comparestack("SelectedPhotons_Eta_excl2_1_", "#eta^{#gamma_{1}}, 2 jet exclusive", 30, -3, 3); // endcaps or total
	}
	
	corrected_comparestack("SelectedPhotons_Phi_excl2_1_", "#varphi^{#gamma_{1}}, 2 jet exclusive", 20, -999, -999);
}
