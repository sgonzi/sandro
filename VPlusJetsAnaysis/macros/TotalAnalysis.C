...
void TotalAnalysis_GJets_HT_xToy(){
	...
	GJetsAnalyzer MC_GJets_HT_400ToInf(0,14);
...
void TotalAnalysis_G_Pt_XtoY(){
	...
	// MC signal G_Pt-XtoY --------------------------------------------------	
	GJetsAnalyzer MC_G_Pt_15to30(0,21);
	MC_G_Pt_15to30.Loop();

	GJetsAnalyzer MC_G_Pt_30to50(0,22);
	MC_G_Pt_30to50.Loop();

	GJetsAnalyzer MC_G_Pt_50to80(0,23);
	MC_G_Pt_50to80.Loop();

	GJetsAnalyzer MC_G_Pt_80to120(0,24);
	MC_G_Pt_80to120.Loop();

	GJetsAnalyzer MC_G_Pt_120to170(0,25);
	MC_G_Pt_120to170.Loop();

	GJetsAnalyzer MC_G_Pt_170to300(0,26);
	MC_G_Pt_170to300.Loop();

	GJetsAnalyzer MC_G_Pt_300to470(0,27);
	MC_G_Pt_300to470.Loop();

	GJetsAnalyzer MC_G_Pt_470to800(0,28);
	MC_G_Pt_470to800.Loop();

	GJetsAnalyzer MC_G_Pt_800to1400(0,29);
	MC_G_Pt_800to1400.Loop();

	GJetsAnalyzer MC_G_Pt_1400to1800(0,30);
	MC_G_Pt_1400to1800.Loop();

	GJetsAnalyzer MC_G_Pt_1800(0,31);
	MC_G_Pt_1800.Loop();
}
...
void TotalAnalysis_DiPhotonJets(){
	...
	// MC DiPhotonJets ------------------------------------------------------
	GJetsAnalyzer MC_DiPhotonJets(0,41);
...
void TotalAnalysis_QCD_Pt_x_y_EMEnriched(){
	...
	GJetsAnalyzer MC_QCD_Pt_20_30_EMEnriched(0,51);
	MC_QCD_Pt_20_30_EMEnriched.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_30_80_EMEnriched(0,52);
	MC_QCD_Pt_30_80_EMEnriched.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_80_170_EMEnriched(0,53);
	MC_QCD_Pt_80_170_EMEnriched.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_170_250_EMEnriched(0,54);
	MC_QCD_Pt_170_250_EMEnriched.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_250_350_EMEnriched(0,55);
	MC_QCD_Pt_250_350_EMEnriched.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_350_EMEnriched(0,56);
...
void TotalAnalysis_QCD_Pt_x_y_BCtoE(){
	...
	GJetsAnalyzer MC_QCD_Pt_20_30_BCtoE(0,61);
	MC_QCD_Pt_20_30_BCtoE.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_30_80_BCtoE(0,62);
	MC_QCD_Pt_30_80_BCtoE.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_80_170_BCtoE(0,63);
	MC_QCD_Pt_80_170_BCtoE.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_170_250_BCtoE(0,64);
	MC_QCD_Pt_170_250_BCtoE.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_250_350_BCtoE(0,65);
	MC_QCD_Pt_250_350_BCtoE.Loop();
	
	GJetsAnalyzer MC_QCD_Pt_350_BCtoE(0,66);
...
void TotalAnalysis_QCD_HT_xToy(){
	...
	GJetsAnalyzer MC_QCD_HT_100To250(0,71);
	MC_QCD_HT_100To250.Loop();		

	GJetsAnalyzer MC_QCD_HT_250To500(0,72);
	MC_QCD_HT_250To500.Loop();		

	GJetsAnalyzer MC_QCD_HT_500To1000(0,73);
	MC_QCD_HT_500To1000.Loop();		

	GJetsAnalyzer MC_QCD_HT_1000ToInf(0,74);
