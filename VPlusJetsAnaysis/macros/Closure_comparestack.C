...
void Closure_comparestack(const char* titleh, const char* namevariable, const int rebin, const double x_min, const double x_max){
  ...
  upperPad->cd();
	...
	PSEUDODATA_total_histo->GetXaxis()->SetTitle(namevariable1);
