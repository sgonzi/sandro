...
//  	TBranch      *b_QGVars;
  	...
  	TBranch      *b_PUWeightSysDown;  	
		...
		TurnOn(TTree *tree = 0, Int_t isample = -1);
		virtual ~TurnOn();
...
#ifdef TurnOn_cxx
TurnOn::TurnOn(TTree *tree, Int_t isample) {
  ...
  if (tree == 0) {
		...
		bool outrange;
		outrange = mysample < 0 || (mysample > 4 && mysample < 11) || (mysample > 17 && mysample < 21) || (mysample > 24 && mysample < 31) || (mysample > 41 && mysample < 51) || (mysample > 51 && mysample < 61) || (mysample > 66 && mysample < 71) || (mysample > 76 && mysample < 81) || mysample > 84;
...
Int_t TurnOn::GetEntry(Long64_t entry) {
...
Long64_t TurnOn::LoadTree(Long64_t entry) {
...
void TurnOn::Show(Long64_t entry) {
...
Int_t TurnOn::Cut(Long64_t entry) {
...
/*
TString TurnOn::floatToString(float number){
	ostringstream oss;
	oss << number;
	return oss.str();
}
*/
#endif // #ifdef TurnOn_cxx
